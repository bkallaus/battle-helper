    ...
    <div className="builder-panel">
      ...
      <div className="form-group">
        ...
        <div className="species-input-container" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
          <div className="input-with-clear" style={{ flex: 1, minWidth: '200px' }}>
            ...
            />
            {config.species && (
              <button type="button" className="clear-input-btn" onClick={() => { setConfig({ ...config, species: '', moves: [] }); setTimeout(() => speciesInputRef.current?.focus(), 0); }} aria-label="Clear species">✕</button>
            )}
          </div>
      ...
      <div className="form-group">
        ...
        <div className="input-with-clear">
          ...
          />
          {config.nature && (
            <button type="button" className="clear-input-btn" onClick={() => { setConfig({ ...config, nature: "Serious" }); setTimeout(() => natureInputRef.current?.focus(), 0); }} aria-label="Clear nature">✕</button>
          )}
        </div>
