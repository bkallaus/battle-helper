...
export const TypeChartPanel = () => {
  ...
  return (
    <div className="builder-panel" style={{ marginTop: '1.5rem' }}>
      ...
      <div style={{ marginTop: '32px', padding: '24px', borderRadius: '16px', background: '#ffffff', border: `1px solid ${resultBorder}`, boxShadow: 'var(--surface-1-shadow)' }} role="status" aria-live="polite">
