...
export const TypeChartPanel = () => {
  ...
  return (
    <div className="builder-panel" style={{ marginTop: '1.5rem' }}>
      ...
      <div role="status" aria-live="polite" style={{ marginTop: '32px', padding: '24px', borderRadius: '16px', background: '#ffffff', border: `1px solid ${resultBorder}`, transition: 'border 0.3s ease', boxShadow: 'var(--surface-1-shadow)' }}>
