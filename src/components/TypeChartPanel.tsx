...
export const TypeChartPanel = () => {
  ...
  return (
    <div className="builder-panel" style={{ marginTop: '1.5rem' }}>
      ...
      <div className="form-group" style={{ marginBottom: '1.5rem' }}>
        <label id="defending-types-label">Defending Type(s) - Select up to 2</label>
        <div role="group" aria-labelledby="defending-types-label" style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '0.5rem' }}>
          {allTypes.map(t => {
