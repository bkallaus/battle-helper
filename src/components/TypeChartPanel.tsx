  ...
  return (
    <div className="builder-panel" style={{ marginTop: '1.5rem' }}>
      ...
      <div className="form-group" style={{ marginBottom: '1.5rem' }}>
        ...
        <div
          role="group"
          aria-labelledby="attacking-type-label"
      ...
      <div className="form-group" style={{ marginBottom: '1.5rem' }}>
        ...
        <div
          role="group"
          aria-labelledby="defending-type-label"
          style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '0.5rem' }}
        >
          {allTypes.map(t => {
      ...
      <div className="form-group" style={{ marginBottom: '1.5rem', maxWidth: '300px' }}>
        ...
        <div className="input-with-clear" style={{ marginTop: '0.5rem' }}>
          ...
          />
          {defendingSpecies && (
            <button type="button" className="clear-input-btn" onClick={() => { setDefendingSpecies(''); }} aria-label="Clear defending Pokémon">✕</button>
          )}
        </div>
